...
export const blockDataList1: BlockData[] = [
  ...
  {
    title: '최고의 즐길 거리, 모두 여기에',
    subtitle: '4가지 혜택을 한 번의 축의금으로 부담 없이.',
    showViewMore: true,
    imageUrl: '/photo/15x10_DHZ4769.jpg',
  },
];
...
export const blockDataList2: BlockData[] = [
  ...
  },
  {
    ...
    showViewMore: true,
    imageUrl: '/wedding/bridal-room.jpg',
    colorMode: 'whiteMode',
  },
  {
    title: '편리한 대중 교통',
    subtitle: '지하철 3개 호선이 지나는 고속버스 터미널 역 근처.',
    showViewMore: true,
    imageUrl: '/wedding/subway.png',
    colorMode: 'whiteMode',
  },
  {
    title: '맛으로 유명한 뷔페',
    subtitle: '밥펠가모 - 100가지 이상의 맛있는 음식.',
    showViewMore: true,
    imageUrl: '/wedding/buffet.jpg',
    colorMode: 'whiteMode',
  },
];
